...
function my_script_init() {
  ...
  wp_enqueue_style('hljs-2', get_template_directory_uri().'/css/tomorrow-night-eighties.css', array(), '1.0.0', 'all');
  if( is_single() ){
    wp_enqueue_script('sns', get_template_directory_uri() . '/js/sns.js', array( 'jquery' ), '1.0.0', true);
  }
  wp_enqueue_script('hljs', get_template_directory_uri() . '/js/highlight.pack.js', array( 'jquery' ), '1.0.0', true);
...
function highlight_shortcode($class, $content = ''){    //引数として$classと$contentを定義。
